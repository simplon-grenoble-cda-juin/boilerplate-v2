...
-- TABLE D’AUTHENTIFICATION (fusionnée avec player)
...
CREATE TABLE public.token (
    ...
    expires_at timestamp without time zone NOT NULL DEFAULT (now() + interval '12 hours'),
...
ALTER TABLE ONLY public.token
  ADD CONSTRAINT token_user_id_unique UNIQUE (user_id);
